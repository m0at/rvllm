...
pub struct Mistral35ForwardKernels {
    ...
    pub fn_mistral35_w4a16_gemm_mma_bf16: KernelFn,
    pub mistral35_w4a16_gemm_mma_v2_bf16_mod: LoadedModule,
    ...
    pub mistral35_w4a16_gemm_mma_v5_bf16_mod: LoadedModule,
    pub fn_mistral35_w4a16_gemm_mma_v5_bf16: KernelFn,
    pub mistral35_w4a16_gemm_mma_v6_bf16_mod: LoadedModule,
    pub fn_mistral35_w4a16_gemm_mma_v6_bf16: KernelFn,
    pub mistral35_w4a16_gemm_mma_v7_bf16_mod: LoadedModule,
    pub fn_mistral35_w4a16_gemm_mma_v7_bf16: KernelFn,
    pub mistral35_w4a16_gemm_mma_v8_bf16_mod: LoadedModule,
    pub fn_mistral35_w4a16_gemm_mma_v8_bf16: KernelFn,
...
impl Mistral35Bringup {
    ...
    pub fn load(paths: Mistral35EnginePaths, arena_bytes: usize) -> Result<Self> {
        ...
        let (ctx, stream, arena, model, forward_kernels_opt, cublaslt_opt,
            ...
            let mistral35_w4a16_gemm_mma_bf16_mod =
                kernels.load_ptx("mistral35_w4a16_gemm_mma_bf16")?;
            let fn_mistral35_w4a16_gemm_mma_bf16 = mistral35_w4a16_gemm_mma_bf16_mod
                .get_function("mistral35_w4a16_gemm_mma_bf16_kernel")?;
            let mistral35_w4a16_gemm_mma_v2_bf16_mod =
                kernels.load_ptx("mistral35_w4a16_gemm_mma_v2_bf16")?;
            let fn_mistral35_w4a16_gemm_mma_v2_bf16 =
                mistral35_w4a16_gemm_mma_v2_bf16_mod
                    .get_function("mistral35_w4a16_gemm_mma_v2_bf16_kernel")?;
            let mistral35_w4a16_gemm_mma_v3_bf16_mod =
                kernels.load_ptx("mistral35_w4a16_gemm_mma_v3_bf16")?;
            ...
            let mistral35_w4a16_gemm_mma_v5_bf16_mod =
                kernels.load_ptx("mistral35_w4a16_gemm_mma_v5_bf16")?;
            let fn_mistral35_w4a16_gemm_mma_v5_bf16 =
                mistral35_w4a16_gemm_mma_v5_bf16_mod
                    .get_function("mistral35_w4a16_gemm_mma_v5_bf16_kernel")?;
            let mistral35_w4a16_gemm_mma_v6_bf16_mod =
                kernels.load_ptx("mistral35_w4a16_gemm_mma_v6_bf16")?;
            let fn_mistral35_w4a16_gemm_mma_v6_bf16 =
                mistral35_w4a16_gemm_mma_v6_bf16_mod
                    .get_function("mistral35_w4a16_gemm_mma_v6_bf16_kernel")?;
            let mistral35_w4a16_gemm_mma_v7_bf16_mod =
                kernels.load_ptx("mistral35_w4a16_gemm_mma_v7_bf16")?;
            let fn_mistral35_w4a16_gemm_mma_v7_bf16 =
                mistral35_w4a16_gemm_mma_v7_bf16_mod
                    .get_function("mistral35_w4a16_gemm_mma_v7_bf16_kernel")?;
            let mistral35_w4a16_gemm_mma_v8_bf16_mod =
                kernels.load_ptx("mistral35_w4a16_gemm_mma_v8_bf16")?;
            let fn_mistral35_w4a16_gemm_mma_v8_bf16 =
                mistral35_w4a16_gemm_mma_v8_bf16_mod
            ...
            let forward_kernels = Mistral35ForwardKernels {
                ...
                fn_mistral35_w4a16_gemm_mma_bf16,
                mistral35_w4a16_gemm_mma_v2_bf16_mod,
                ...
                mistral35_w4a16_gemm_mma_v5_bf16_mod,
                fn_mistral35_w4a16_gemm_mma_v5_bf16,
                mistral35_w4a16_gemm_mma_v6_bf16_mod,
                fn_mistral35_w4a16_gemm_mma_v6_bf16,
                mistral35_w4a16_gemm_mma_v7_bf16_mod,
                fn_mistral35_w4a16_gemm_mma_v7_bf16,
                mistral35_w4a16_gemm_mma_v8_bf16_mod,
                fn_mistral35_w4a16_gemm_mma_v8_bf16,
...
impl Mistral35Bringup {
    ...
    unsafe fn forward_chunk_body(
        ...
        let gemm_at_m = |out_bf16_ptr: u64,
            ...
            let n = lin.shape.n as i32;
            let k = lin.shape.k as i32;
            // Fused W4A16 M>1 path — tensor-core mma v8 (persistent
            // CTA over M, BN=32, cp.async 2-stage K-pipeline).
            if use_fused_w4a16_mma_v8 && m > 0 && k % 16 == 0 && n % 32 == 0 {
                unsafe {
                    ...
                    rvllm_fused::launch_raw(
                        kernels.fn_mistral35_w4a16_gemm_mma_v8_bf16,
                        (n_tiles, 1, 1),
                        (128, 1, 1),
                        0, stream_u64, &args,
                    )?;
            ...
            // Fused W4A16 M>1 path — tensor-core mma v7 (BM=128,
            // BN=32, cp.async 3-stage K-pipeline).
            if use_fused_w4a16_mma_v7 && m > 0 && k % 16 == 0 && n % 32 == 0 {
                unsafe {
                    let mut out = out_bf16_ptr;
                    let mut wp = lin.packed_ptr;
                    let mut ws = lin.sfb_natural_ptr;
                    ...
                    rvllm_fused::launch_raw(
                        kernels.fn_mistral35_w4a16_gemm_mma_v7_bf16,
                        (n_tiles, m_tiles, 1),
                        (128, 1, 1),
                        0, stream_u64, &args,
                    )?;
            ...
            // Fused W4A16 M>1 path — tensor-core mma v6 (BM=128,
            // BN=32, cp.async 2-stage K-pipeline on top of v4).
            if use_fused_w4a16_mma_v6 && m > 0 && k % 16 == 0 && n % 32 == 0 {
                unsafe {
                    let mut out = out_bf16_ptr;
                    let mut wp = lin.packed_ptr;
                    let mut ws = lin.sfb_natural_ptr;
                    ...
                    let m_tiles = (((m as u32) + bm - 1) / bm).max(1);
                    rvllm_fused::launch_raw(
                        kernels.fn_mistral35_w4a16_gemm_mma_v6_bf16,
                        (n_tiles, m_tiles, 1),
                        (128, 1, 1),
                        0, stream_u64, &args,
                    )?;
            ...
            // Fused W4A16 M>1 path — tensor-core mma v5 (BM=256,
            // BN=32, smem A-tile reuse + 16 M-tiles per CTA).
            if use_fused_w4a16_mma_v5 && m > 0 && k % 16 == 0 && n % 32 == 0 {
                unsafe {
                    let mut out = out_bf16_ptr;
                    let mut wp = lin.packed_ptr;
                    let mut ws = lin.sfb_natural_ptr;
                    ...
                    let m_tiles = (((m as u32) + bm - 1) / bm).max(1);
                    rvllm_fused::launch_raw(
                        kernels.fn_mistral35_w4a16_gemm_mma_v5_bf16,
                        (n_tiles, m_tiles, 1),
                        (128, 1, 1),
                        0, stream_u64, &args,
                    )?;
            ...
            if use_fused_w4a16_mma_v3 && m > 0 && k % 16 == 0 && n % 32 == 0 {
                unsafe {
                    ...
                    let m_tiles = (((m as u32) + bm - 1) / bm).max(1);
                    rvllm_fused::launch_raw(
                        kernels.fn_mistral35_w4a16_gemm_mma_v3_bf16,
                        (n_tiles, m_tiles, 1),
                        (128, 1, 1),
                        0, stream_u64, &args,
                    )?;
            ...
            // Fused W4A16 M>1 path — tensor-core mma v2 (4 warps,
            // BN=32 per CTA, smem A-tile reuse).
            if use_fused_w4a16_mma_v2 && m > 0 && k % 16 == 0 && n % 32 == 0 {
                unsafe {
                    let mut out = out_bf16_ptr;
                    let mut wp = lin.packed_ptr;
                    let mut ws = lin.sfb_natural_ptr;
                    ...
                    let m_tiles = (((m as u32) + bm - 1) / bm).max(1);
                    rvllm_fused::launch_raw(
                        kernels.fn_mistral35_w4a16_gemm_mma_v2_bf16,
                        (n_tiles, m_tiles, 1),
                        (128, 1, 1),
                        0, stream_u64, &args,
                    )?;
            ...
            // Fused W4A16 M>1 path — tensor-core mma.sync v1 variant.
            // Single-warp BM=16 BN=8 BK=16 grid; n and m may be
            // partial in the last block, kernel guards bounds.
            if use_fused_w4a16_mma && m > 0 && k % 16 == 0 && n % 8 == 0 {
                unsafe {
                    let mut out = out_bf16_ptr;
                    let mut wp = lin.packed_ptr;
                    let mut ws = lin.sfb_natural_ptr;
                    ...
                    let m_tiles = (((m as u32) + bm - 1) / bm).max(1);
                    rvllm_fused::launch_raw(
                        kernels.fn_mistral35_w4a16_gemm_mma_bf16,
                        (n_tiles, m_tiles, 1),
                        (32, 1, 1),
                        0, stream_u64, &args,
                    )?;
            ...
            // Fused W4A16 M>1 path — no BF16 weight scratch (CUDA core).
