...
//!
//! Supports two weight-loading paths:
//! - `load_weights_to_gpu`: widens weights to f32 (original path)
//! - `load_weights_to_gpu_f16`: keeps f16 as-is, bf16 narrows to f16, and f32
//!   narrows to f16 to cut VRAM and enable hgemm.
